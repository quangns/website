        ...
        <div class="cat-content">
        	<div class="col1">
            	<div class="news">
                    <?php
                        ...
                        $row_tintrai = mysqli_fetch_assoc($tintrai);
                    ?>
                    <h3 class="title" ><a href="index.php?p=tintrongloai&idTin=<?php echo $row_tintrai['idTin'] ?>"><?php echo $row_tintrai['TieuDe'] ?> </a></h3>
            ...
            <div class="col2">
                <?php
                    ...
                    while($row_tinphai = mysqli_fetch_assoc($tinphai)) {
                ?>
                <p class="tlq"><a href="index.php?p=tintrongloai&idTin=<?php echo $row_tinphai['idTin'] ?>"><?php echo $row_tinphai['TieuDe'] ?> </a></p>
                <?php
                    }
                ?>
            </div>    
